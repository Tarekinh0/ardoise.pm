...
4. Invoke reviews in parallel (or sequentially as needed):
   - **ardoise-ciso** → produces `ciso-review.md` in a temporary gate context.
   - **ardoise-dpo** → produces `dpo-review.md`.
   - **ardoise-qa** → produces `qa-review.md`.
5. If CI/CD workflows or release artifacts are affected:
   - **ardoise-release** → produces `release-review.md`.
