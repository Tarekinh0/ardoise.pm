// Adapté de Qindu, paquet internal/pii — fichier entity.go (origine
// AGPL-3.0 ; reprise approuvée par le titulaire des droits, pont de
// licence suivi au registre des risques R-006). Sous-ensemble : seuls les
// types d'authentifiants (JWT, Secret, PrivateKey) sont conservés — voir
// le commentaire du paquet (secrets.go).
